...
<?php   include "./includes/nav_home.php";    ?>
    <div class="main">
        ...
        <section id="sponsers">
            <div class="container">
                <h1 class="wow fadeInUp" data-wow-delay="0.4">Partner Universities</h1>
                <p class="wow fadeInUp" data-wow-delay="1.0s">Affiliated to the Top Ranked Universities</p>
                <div class="row">
                    <div class=" col-sm-3">
        ...
        <section id="courses">
            <div class="container">
                <h1 class="wow fadeInUp" data-wow-delay="0.4">Courses</h1>
                <p class="wow fadeInUp" data-wow-delay="0.6s">Imagine Your Future With No Limits!</p>
                <div class="box col-sm-4 wow flipInY" data-wow-delay="1.0s">
        ...
        <section id="about">
            <div class="container">
                <h1 class="wow fadeInUp" data-wow-delay="0.2s">About NSBM</h1>
        ...
        <section id="contact">
            <div class="container head wow slideInUp" data-wow-delay="0.3s">
