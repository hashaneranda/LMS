...
<?php   include "./includes/nav_courses.php";    ?>
        ...
        $query ="select DISTINCT yr from courses where dept_ID ='SOB' order by yr";
        ...
        <div id="expand<?php echo $i ?>">
            ...
            ?>
                   ...
                   <a href="<?php echo $x ?>?mod_code=<?php echo $module_code ?>&mod_name=<?php echo $module_name ?>&dept=<?php echo 'SOB' ?>"><p><b><?php echo $module_code ?></b><?php echo $module_name ?></p></a>
                  <?php 
                }
            $i++;
            ?>
